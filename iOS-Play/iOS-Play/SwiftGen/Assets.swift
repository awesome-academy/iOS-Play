...
internal enum Asset {
  ...
  internal static let shareBlack = ImageAsset(name: "shareBlack")
  internal static let skipTrack = ImageAsset(name: "skip-track")
  ...
  internal static let bogia = ImageAsset(name: "bogia")
  ...
  internal static let wwdc1 = ImageAsset(name: "wwdc1")
  internal static let wwdc2 = ImageAsset(name: "wwdc2")
}
