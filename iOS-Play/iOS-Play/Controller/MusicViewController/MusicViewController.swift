...
final class MusicViewController: UIViewController {
    ...
    private let segmentItems = FeedType.musics.item
    ...
    func configChildView() {
        ...
        hotVC.view.tag = 0
        newVC.view.tag = 1
        topAlbumVC.view.tag = 2
        topSongVC.view.tag = 3
        commingVC.view.tag = 4
...
extension MusicViewController: UIPageViewControllerDelegate, UIPageViewControllerDataSource {
